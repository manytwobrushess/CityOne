...
class CrowdManagement2 extends StatefulWidget {
	const CrowdManagement2({super.key});
	@override
		CrowdManagement2State createState() => CrowdManagement2State();
	}
class CrowdManagement2State extends State<CrowdManagement2> {
	@override
										...
										child: Column(
											...
											children: [
												SizedBox(
													...
													width: double.infinity,
													child: Image.network(
														"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/6XNfkLtyKU/bndmq1lt.png",
														fit: BoxFit.fill,
													)
												),
												IntrinsicHeight(
														...
														child: Row(
															children: [
																Container(
																	...
																	height: 24,
																	child: Image.network(
																		"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/6XNfkLtyKU/le78uq5f.png",
																		fit: BoxFit.fill,
																	)
																),
																Expanded(
																...
																SizedBox(
																	...
																	height: 23,
																	child: Image.network(
																		"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/6XNfkLtyKU/mg79zbpg.png",
																		fit: BoxFit.fill,
																	)
																),
															]
															...
															child: Row(
																children: [
																	Container(
																		...
																		height: 13,
																		child: Image.network(
																			"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/6XNfkLtyKU/ypn7h9sx.png",
																			fit: BoxFit.fill,
																		)
																	),
																	SizedBox(
																...
																IntrinsicWidth(
																	child: IntrinsicHeight(
																		child: Container(
																			...
																			padding: const EdgeInsets.only( top: 8, bottom: 8, left: 57, right: 14),
																			child: Row(
																				children: [
																					Container(
																					...
																					Container(
																						...
																						child: ClipRRect(
																							borderRadius: BorderRadius.circular(4),
																							child: Image.network(
																								"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/6XNfkLtyKU/2c10pdv5.png",
																								fit: BoxFit.fill,
																							)
																						)
																					),
														...
														child: Column(
															...
															children: [
																...
																SizedBox(
																	...
																	width: double.infinity,
																	child: Image.network(
																		"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/6XNfkLtyKU/kdugmb9s.png",
																		fit: BoxFit.fill,
																	)
																),
															]
															...
															child: Row(
																children: [
																	Container(
																		...
																		height: 10,
																		child: Image.network(
																			"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/6XNfkLtyKU/pan3cwz7.png",
																			fit: BoxFit.fill,
																		)
																	),
																	Text(
												...
												IntrinsicHeight(
													child: Container(
														...
														padding: const EdgeInsets.only( top: 6, bottom: 6, left: 26, right: 26),
																			...
																			child: Row(
																				children: [
																					Container(
																						...
																						height: 13,
																						child: Image.network(
																							"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/6XNfkLtyKU/qwfmps4p.png",
																							fit: BoxFit.fill,
																						)
																					),
																					SizedBox(
																					...
																					child: IntrinsicWidth(
																						child: IntrinsicHeight(
																							child: Container(
																								...
																								padding: const EdgeInsets.only( top: 8, bottom: 8, left: 63, right: 63),
																								margin: const EdgeInsets.only( bottom: 10),
																								child: Column(
																									crossAxisAlignment: CrossAxisAlignment.start,
																									children: [
