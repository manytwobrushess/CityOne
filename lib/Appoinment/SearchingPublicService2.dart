...
class SearchingPublicService2 extends StatefulWidget {
	const SearchingPublicService2({super.key});
	@override
		SearchingPublicService2State createState() => SearchingPublicService2State();
	}
class SearchingPublicService2State extends State<SearchingPublicService2> {
	String textField1 = '';
	String textField2 = '';
	String textField3 = '';
	String textField4 = '';
										...
										child: Column(
											...
											children: [
												SizedBox(
													...
													width: double.infinity,
													child: Image.network(
														"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/6XNfkLtyKU/2bqsjc3a.png",
														fit: BoxFit.fill,
													)
												),
												IntrinsicWidth(
															...
															child: Row(
																...
																children: [
																	Container(
																		...
																		height: 24,
																		child: Image.network(
																			"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/6XNfkLtyKU/chsgkgn9.png",
																			fit: BoxFit.fill,
																		)
																	),
																	Text(
																...
																Row(
																	...
																	children: [
																					...
																					child: Column(
																						...
																						children: [
																							SizedBox(
																								...
																								height: 167,
																								child: Image.network(
																									"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/6XNfkLtyKU/uiavimfk.png",
																									fit: BoxFit.fill,
																								)
																							),
																							Container(
																								...
																								height: 167,
																								child: Image.network(
																									"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/6XNfkLtyKU/9bj63c2b.png",
																									fit: BoxFit.fill,
																								)
																							),
																						]
																		...
																		SizedBox(
																			...
																			height: 167,
																			child: Image.network(
																				"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/6XNfkLtyKU/uwu1sv8f.png",
																				fit: BoxFit.fill,
																			)
																		),
																	]
																			...
																			child: Row(
																				children: [
																					Container(
																						...
																						height: 79,
																						child: Image.network(
																							"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/6XNfkLtyKU/9tzxk9ax.png",
																							fit: BoxFit.fill,
																						)
																					),
																					IntrinsicWidth(
															...
															children: [
																...
																Container(
																	...
																	child: ClipRRect(
																		borderRadius: BorderRadius.circular(4),
																		child: Image.network(
																			"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/6XNfkLtyKU/s5zxwbn8.png",
																			fit: BoxFit.fill,
																		)
																	)
																),
																					...
																					children: [
																						...
																						Container(
																							...
																							child: ClipRRect(
																								borderRadius: BorderRadius.circular(4),
																								child: Image.network(
																									"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/6XNfkLtyKU/9nd0dsmy.png",
																									fit: BoxFit.fill,
																								)
																							)
																						),
															...
															children: [
																...
																Container(
																	...
																	child: ClipRRect(
																		borderRadius: BorderRadius.circular(4),
																		child: Image.network(
																			"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/6XNfkLtyKU/afftojro.png",
																			fit: BoxFit.fill,
																		)
																	)
																),
															...
															children: [
																...
																Container(
																	...
																	child: ClipRRect(
																		borderRadius: BorderRadius.circular(4),
																		child: Image.network(
																			"https://storage.googleapis.com/tagjs-prod.appspot.com/v1/6XNfkLtyKU/jw10y6q9.png",
																			fit: BoxFit.fill,
																		)
																	)
																),
